...
1. **Locate template** at `C:\Users\jason\OneDrive - jirahgrowth.consulting\Joshua Marshall's files - JIRAH Growth Partners - Shared\NEW - JIRAH MASTER\01 - Clients\_template\`. If OneDrive is unavailable, fall back to `seed-data/active-clients/_template/` in this workspace.
